FUNCTION ZIDOC_INPUT_ZCHGPOINT2_CREATE.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*----------------------------------------------------------------------*
  ...
  DATA:
      Z1ZCHGPOINT2_CREATE like Z1ZCHGPOINT2_CREATE,
...
* check if the function is called correctly                            *
  ...
  IF SY-SUBRC <> 0.
    EXIT.
  ELSEIF IDOC_CONTRL-MESTYP <> 'ZCHGPOINT2_CREATE'.
...
*   through all segments of this IDoc                                  *
    ...
    LOOP AT T_EDIDD INTO IDOC_DATA.
      ...
      CASE IDOC_DATA-SEGNAM.
        ...
        WHEN 'Z1ZCHGPOINT2_CREATE'.

        Z1ZCHGPOINT2_CREATE = IDOC_DATA-SDATA.
    MOVE Z1ZCHGPOINT2_CREATE-PROFILE
      TO PROFILE.
    MOVE Z1ZCHGPOINT2_CREATE-BOMUSAGE
      TO BOMUSAGE.
    MOVE Z1ZCHGPOINT2_CREATE-APPLICATION
      TO APPLICATION.
...
*     write IDoc status-record as error and continue                   *
      ...
      BAPI_IDOC_STATUS      = '51'.
      PERFORM ZIDOC_STATUS_ZCHGPOINT2_CREATE
              TABLES T_EDIDD
                     IDOC_STATUS
                     RETURN_VARIABLES
               USING IDOC_CONTRL
...
*   call BAPI-function in this system                                  *
    CALL FUNCTION 'ZBAPI_ROUTING_CREATE2'
       exporting
        TESTRUN = TESTRUN
        PROFILE = PROFILE
        BOMUSAGE = BOMUSAGE
...
FORM ZIDOC_STATUS_ZCHGPOINT2_CREATE
  ...
  ELSEIF IDOC_STATUS-STATUS = '53'.
    ...
    R_VARIABLES-DOC_NUMBER = 'ZCHGPOINT2'.
    READ TABLE R_VARIABLES FROM R_VARIABLES.
    IF SY-SUBRC <> 0.
      APPEND R_VARIABLES.
    ENDIF.
...
ENDFORM.                               " ZIDOC_STATUS_ZCHGPOINT2_CREATE
