FUNCTION ZZALE_ROUTING_CREATE1.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"         OPTIONAL
*"     VALUE(OBJ_TYPE) LIKE  SERIAL-OBJ_TYPE DEFAULT 'ZCHGPOINT1'
...
* create IDoc control-record                                           *
  IDOC_CONTROL-MESTYP = 'ZCHGPOINT1_CREATE'.
  IDOC_CONTROL-IDOCTP = 'ZCHGPOINT1_CREATE01'.
...
*   call subroutine to create IDoc data-record                         *
    ...
    REFRESH IDOC_DATA.
    PERFORM ZZIDOC_ROUTING_CREATE1
            TABLES
                TASK
...
form ZZIDOC_ROUTING_CREATE1
  ...
  data:  Z1ZCHGPOINT1_CREATE like Z1ZCHGPOINT1_CREATE.
...
* for segment 'Z1ZCHGPOINT1_CREATE'                                    *
    clear: Z1ZCHGPOINT1_CREATE,
           idoc_data.
    move PROFILE
      to Z1ZCHGPOINT1_CREATE-PROFILE.
    move BOMUSAGE
      to Z1ZCHGPOINT1_CREATE-BOMUSAGE.
    move APPLICATION
      to Z1ZCHGPOINT1_CREATE-APPLICATION.
    idoc_data-sdata  = Z1ZCHGPOINT1_CREATE.
    idoc_data-segnam = 'Z1ZCHGPOINT1_CREATE'.
    append idoc_data.
...
endform.                               " ZZIDOC_ROUTING_CREATE1
