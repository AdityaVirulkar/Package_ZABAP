...
*"         OPTIONAL
*"     VALUE(OBJ_TYPE) LIKE  SERIAL-OBJ_TYPE DEFAULT 'ZCHGPOINT'
...
* create IDoc control-record                                           *
  IDOC_CONTROL-MESTYP = 'ZCHGPOINT_CREATE'.
  IDOC_CONTROL-IDOCTP = 'ZCHGPOINT_CREATE01'.
...
form ZZIDOC_ROUTING_CREATE
  ...
  data:  Z1ZCHGPOINT_CREATE like Z1ZCHGPOINT_CREATE.
...
* for segment 'Z1ZCHGPOINT_CREATE'                                     *
    clear: Z1ZCHGPOINT_CREATE,
           idoc_data.
    move PROFILE
      to Z1ZCHGPOINT_CREATE-PROFILE.
    move BOMUSAGE
      to Z1ZCHGPOINT_CREATE-BOMUSAGE.
    move APPLICATION
      to Z1ZCHGPOINT_CREATE-APPLICATION.
    idoc_data-sdata  = Z1ZCHGPOINT_CREATE.
    idoc_data-segnam = 'Z1ZCHGPOINT_CREATE'.
    append idoc_data.
