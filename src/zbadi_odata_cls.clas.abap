class ZBADI_ODATA_CLS definition
  public
  final
  create public .
...
CLASS ZBADI_ODATA_CLS IMPLEMENTATION.


  method Z_ODATA_INTERFACE~CHECK_EDM_TYPE.
      TYPES:
...
*        ASSERT 1 = 0. "unsupported type
  ...
  method Z_ODATA_INTERFACE~GET_ODATA_OPCODES.
...
* End of changes by Akshay for OData_Def_24
    ...
    DATA : lv_icf_name         TYPE icfname,
           lwa_final           TYPE ZHANA_DETECTION1,
...
*        ENDIF.
  ...
  method Z_ODATA_INTERFACE~IS_VALID_ODATA_CLASS.
